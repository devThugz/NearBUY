...
export default function UnifiedOrderHistory() {
  ...
  return <div className="space-y-6">
      ...
      {/* Desktop Table View */}
      <div className="hidden md:block bg-m2m-bg-card rounded-xl shadow-lg overflow-hidden border border-m2m-divider">
        <table className="min-w-full divide-y divide-m2m-divider">
          <thead className="bg-m2m-bg-primary/50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-m2m-text-secondary uppercase tracking-wider">
                Order ID
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-m2m-text-secondary uppercase tracking-wider">
                Product
          ...
          <tbody className="bg-m2m-bg-card divide-y divide-m2m-divider">
            {orders.map(order => <tr key={order.id} className="hover:bg-m2m-bg-primary/30 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-m2m-text-primary">
                  {order.id}
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-m2m-text-secondary">
                  {order.quantity}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-m2m-text-secondary">
                  {order.date}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-m2m-text-primary">
      ...
      <div className="md:hidden space-y-4">
        {orders.map(order => <div key={order.id} className="bg-m2m-bg-card rounded-xl shadow-lg p-4 border border-m2m-divider">
            ...
            <div className="flex justify-between items-center pt-3 border-t border-m2m-divider">
