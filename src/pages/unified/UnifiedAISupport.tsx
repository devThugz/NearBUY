...
export default function UnifiedAISupport() {
  ...
  const [messages, setMessages] = useState<Message[]>([
  {
    ...
    type: 'assistant',
    content:
    "Hello! I'm your AI assistant. I can help you with business setup, location insights, document requirements, and more.",
    timestamp: '10:30 AM'
  }]
  );
  ...
  const knowledgeBaseArticles = [
  {
    ...
    description:
    'Explains AI data points like demographics and market trends.',
    helpful: 45,
    views: 120
  },
  {
    ...
    description:
    'Lists common permits like BIR, Business Permit, Sanitary, etc.',
    helpful: 38,
    views: 95
  },
  {
  ...
  },
  {
    ...
    description:
    'Best practices for choosing the right location for your business.',
    helpful: 67,
    views: 203
  },
  {
    ...
    description:
    'How to connect with suppliers and manage your supply chain.',
    helpful: 41,
    views: 112
  },
  {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiResponse: Message = {
        ...
        type: 'assistant',
        content:
        'I understand your question. Let me help you with that. Our AI system analyzes multiple data points including demographics, market trends, and competitor locations to provide you with the best business insights.',
        timestamp: new Date().toLocaleTimeString([], {
          hour: '2-digit',
          minute: '2-digit'
        })
        ...
        {tabs.map((tab) => {
          ...
          return (
            <motion.button
              ...
              className={`flex items-center space-x-2 px-6 py-3 font-medium transition-all relative ${activeTab === tab.id ? 'text-m2m-accent-blue' : 'text-m2m-text-secondary hover:text-m2m-text-primary'}`}>
              ...
              <motion.div
                layoutId="activeTab"
                className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal"
                transition={{
                  type: 'spring',
                  stiffness: 500,
                  damping: 30
            ...
            <div className="lg:col-span-2 bg-m2m-bg-card rounded-2xl shadow-lg border border-m2m-divider overflow-hidden flex flex-col h-[600px]">
              ...
              <motion.div
                ...
                className={`flex ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                    ...
                    <div
                  className={`max-w-[80%] rounded-2xl px-4 py-3 ${message.type === 'user' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white' : 'bg-m2m-bg-card border border-m2m-divider text-m2m-text-primary'}`}>

                      <p className="text-sm">{message.content}</p>
                      <p
                    className={`text-xs mt-1 ${message.type === 'user' ? 'text-white/70' : 'text-m2m-text-secondary'}`}>
              ...
              <div className="p-4 bg-m2m-bg-card border-t border-m2m-divider">
                <div className="flex space-x-2">
                  ...
                  className="flex-1 px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-medium hover:shadow-lg transition-all">
          ...
          className="space-y-6">
            ...
            <div className="bg-m2m-bg-card rounded-2xl shadow-lg border border-m2m-divider p-6">
              <div className="relative">
                ...
                className="w-full pl-12 pr-4 py-4 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />
            ...
            <div className="bg-m2m-bg-card rounded-2xl shadow-lg border border-m2m-divider p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />
                ...
                <div>
                  ...
                  rows={6}
                  className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors resize-none" />
                ...
                className="w-full py-4 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-semibold hover:shadow-lg transition-all">
              ...
              <motion.div
                ...
                className="p-4 bg-m2m-bg-primary rounded-xl border border-m2m-divider">
                      ...
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${ticket.status === 'Open' ? 'bg-m2m-accent-blue/20 text-m2m-accent-blue' : ticket.status === 'In Progress' ? 'bg-m2m-accent-orange/20 text-m2m-accent-orange' : 'bg-m2m-success/20 text-m2m-success'}`}>
