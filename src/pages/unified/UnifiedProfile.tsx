    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <form
            onSubmit={handleSave}
            className="bg-m2m-bg-card rounded-xl shadow-lg p-6 space-y-6 border border-m2m-divider">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center">
