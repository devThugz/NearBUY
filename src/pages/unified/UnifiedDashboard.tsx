    ...
    <div className="space-y-6">
        ...
        <motion.div
          ...
          className="bg-m2m-bg-card rounded-xl shadow-lg p-4 border border-m2m-divider hover:shadow-2xl transition-all duration-300">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <span
              className={`text-xs font-semibold ${kpi.changeType === 'increase' ? 'text-m2m-success' : kpi.changeType === 'warning' ? 'text-m2m-chart-yellow' : 'text-m2m-text-secondary'}`}>
      ...
      <motion.div
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <button
            ...
            className="flex flex-col items-center justify-center p-4 bg-m2m-bg-primary rounded-lg hover:bg-m2m-accent-blue/10 hover:border-m2m-accent-blue border border-m2m-divider transition-all duration-300 group">
          ...
          <Link
            to="/dashboard/orders"
            className="flex flex-col items-center justify-center p-4 bg-m2m-bg-primary rounded-lg hover:bg-m2m-accent-teal/10 hover:border-m2m-accent-teal border border-m2m-divider transition-all duration-300 group">
          ...
          <Link
            ...
            className="flex flex-col items-center justify-center p-4 bg-m2m-bg-primary rounded-lg hover:bg-m2m-success/10 hover:border-m2m-success border border-m2m-divider transition-all duration-300 group">
          ...
          <Link
            to="/dashboard/map"
            className="flex flex-col items-center justify-center p-4 bg-m2m-bg-primary rounded-lg hover:bg-m2m-accent-orange/10 hover:border-m2m-accent-orange border border-m2m-divider transition-all duration-300 group">
          ...
          <Link
            ...
            className="flex flex-col items-center justify-center p-4 bg-m2m-bg-primary rounded-lg hover:bg-purple-500/10 hover:border-purple-500 border border-m2m-divider transition-all duration-300 group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <Link
            to="/dashboard/map"
            className="block relative h-64 bg-gradient-to-br from-m2m-accent-blue/10 to-m2m-accent-teal/10 hover:opacity-90 transition-opacity">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="space-y-2">
            ...
            {inventoryStatus.fastMoving.map((product, index) =>
            <div
              key={index}
              className="flex items-center justify-between p-2 bg-m2m-bg-primary rounded-lg">
          ...
          <div className="space-y-3">
            ...
            <motion.div
              ...
              className="flex items-start space-x-3 p-3 rounded-lg hover:bg-m2m-bg-primary transition-all duration-300">
                ...
                <div
                className={`p-2 rounded-lg bg-m2m-bg-primary ${activity.color}`}>
      ...
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {inventoryStatus.restockSuggestions.map((product, index) =>
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-m2m-bg-primary rounded-lg hover:bg-m2m-accent-blue/10 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <motion.div
          ...
          transition={{
            ...
            <Link
            to={stat.link}
            className="block bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider hover:shadow-2xl transition-all duration-300 ease-in-out hover:-translate-y-1 group">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                className={`flex items-center space-x-1 text-sm font-semibold ${stat.changeType === 'increase' ? 'text-m2m-success' : 'text-m2m-accent-orange'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="grid grid-cols-6 gap-4 h-48">
            {recentOrderStats.map((stat, index) =>
            <motion.div
              key={index}
              initial={{
                height: 0,
              ...
              className="flex flex-col items-center justify-end">
                ...
                className="w-full bg-gradient-to-t from-m2m-accent-blue to-m2m-accent-teal rounded-t-lg transition-all duration-300 hover:opacity-80 origin-bottom cursor-pointer"
                style={{
            ...
            <tbody>
              ...
              <motion.tr
                ...
                className="border-b border-m2m-divider hover:bg-m2m-bg-primary transition-all duration-300">
                  ...
                  <td className="py-4 px-4 text-center">
                    {product.trend === 'up' ?
                  <div className="inline-flex items-center space-x-1 px-2 py-1 bg-m2m-success/10 rounded-full">
                  ...
                  <div className="inline-flex items-center space-x-1 px-2 py-1 bg-m2m-accent-orange/10 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4 max-w-md">
          <motion.div
            ...
            <Link
              ...
              className="block p-4 border-2 border-m2m-divider rounded-lg hover:border-m2m-success hover:bg-m2m-success/10 transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-cyan-400/30">
            ...
            className="fixed top-0 right-0 h-full w-full bg-m2m-bg-primary z-50 overflow-y-auto">
              ...
              <div className="max-w-6xl mx-auto p-6 space-y-6">
                ...
                <div className="flex items-center justify-between sticky top-0 bg-m2m-bg-primary pb-4 border-b border-m2m-divider z-10">
                  ...
                  <button
                  onClick={() => setIsAddProductOpen(false)}
                  className="p-2 hover:bg-m2m-bg-card rounded-lg transition-colors">
                ...
                className="bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all" />
                    ...
                    <div>
                      ...
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all">
                    ...
                    <div className="md:col-span-2">
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all resize-none" />
                    ...
                    <div>
                      ...
                      placeholder="e.g. wholesale, hardware, grocery"
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all" />
                ...
                className="bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider">
                  ...
                  <div className="border-2 border-dashed border-m2m-divider rounded-lg p-8 text-center hover:border-m2m-accent-blue transition-colors">
                    ...
                    className="px-6 py-2 bg-m2m-accent-blue text-white rounded-lg hover:bg-m2m-accent-teal transition-colors">
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 gap-4 mt-6">
                  ...
                  <div
                    key={index}
                    className="relative aspect-square bg-m2m-bg-primary rounded-lg border border-m2m-divider">
                ...
                className="bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                    onClick={addVariant}
                    className="flex items-center space-x-2 px-4 py-2 bg-m2m-accent-blue text-white rounded-lg hover:bg-m2m-accent-teal transition-colors">
                  ...
                  {variants.length === 0 ?
                <div className="text-center py-8 text-m2m-text-secondary">
                      <p>
                  ...
                  <div
                    ...
                    className="bg-m2m-bg-primary rounded-lg p-4 border border-m2m-divider">
                        ...
                        className="p-1 hover:bg-red-500/10 rounded transition-colors">
                          ...
                          className="w-full px-4 py-2 bg-m2m-bg-card border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-all" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        placeholder="L"
                        className="w-full px-3 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-all" />
                    ...
                    <div>
                      ...
                      onChange={(e) => setShippingCategory(e.target.value)}
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all">
                    ...
                    <div>
                      ...
                      onChange={(e) => setCourierOptions(e.target.value)}
                      placeholder="e.g. LBC, J&T, Grab Express"
                      className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue/20 transition-all" />
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="border-2 border-dashed border-m2m-divider rounded-lg p-4 hover:border-m2m-accent-blue transition-colors">
                        ...
                        className="flex items-center space-x-2 text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors">
                ...
                <div className="sticky bottom-0 bg-m2m-bg-primary pt-6 pb-4 border-t border-m2m-divider">
                  <div className="bg-gradient-to-br from-m2m-accent-blue/5 to-m2m-accent-teal/5 rounded-xl shadow-lg p-6 border border-m2m-accent-blue/20">
                    <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
                      ...
                      className="w-full md:w-auto px-8 py-4 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center space-x-2">
                      ...
                      className="w-full md:w-auto px-8 py-4 bg-m2m-bg-card text-m2m-text-primary border-2 border-m2m-divider rounded-xl font-semibold text-lg hover:bg-m2m-bg-primary transition-all flex items-center justify-center space-x-2">
