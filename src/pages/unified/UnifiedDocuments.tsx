...
export default function UnifiedDocuments() {
  ...
  'Main Office - Butuan City',
  'Branch 1 - Agusan del Norte',
  'Branch 2 - Surigao City',
  'Warehouse - Nasipit'];
  ...
  const getCategoryBadge = (category: string) => {
    return (
      <span className="px-2 py-1 text-xs font-semibold bg-m2m-accent-blue/10 text-m2m-accent-blue rounded-full">
        {category}
      </span>);
      ...
      <motion.div
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary appearance-none focus:outline-none focus:border-m2m-accent-blue transition-colors cursor-pointer">
      ...
      <motion.div
        ...
        <div className="flex border-b border-m2m-divider bg-m2m-bg-primary">
          <button
            ...
            className={`flex-1 px-6 py-4 font-semibold transition-all ${activeTab === 'documents' ? 'text-m2m-accent-blue border-b-2 border-m2m-accent-blue bg-m2m-accent-blue/5' : 'text-m2m-text-secondary hover:text-m2m-text-primary hover:bg-m2m-bg-primary'}`}>

            Documents
          </button>
          <button
            onClick={() => setActiveTab('payments')}
            className={`flex-1 px-6 py-4 font-semibold transition-all ${activeTab === 'payments' ? 'text-m2m-accent-blue border-b-2 border-m2m-accent-blue bg-m2m-accent-blue/5' : 'text-m2m-text-secondary hover:text-m2m-text-primary hover:bg-m2m-bg-primary'}`}>

            Payments
          </button>
          <button
            onClick={() => setActiveTab('status')}
            className={`flex-1 px-6 py-4 font-semibold transition-all ${activeTab === 'status' ? 'text-m2m-accent-blue border-b-2 border-m2m-accent-blue bg-m2m-accent-blue/5' : 'text-m2m-text-secondary hover:text-m2m-text-primary hover:bg-m2m-bg-primary'}`}>
          ...
          <AnimatePresence mode="wait">
              ...
              transition={{
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  ...
                  <div className="relative">
                    ...
                    className="w-full md:w-48 px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary appearance-none focus:outline-none focus:border-m2m-accent-blue transition-colors cursor-pointer">
                ...
                <motion.div
                  ...
                  className="bg-m2m-bg-primary rounded-xl p-6 border border-m2m-divider hover:border-m2m-accent-blue hover:shadow-lg transition-all">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex flex-wrap items-center gap-4 text-sm">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <span
                                className={`font-semibold ${doc.paid ? 'text-m2m-success' : 'text-m2m-accent-orange'}`}>
                        ...
                        className="px-4 py-2 bg-m2m-accent-blue text-white rounded-lg font-medium hover:bg-m2m-accent-blue/90 transition-all flex items-center gap-2">
                      ...
                      <motion.button
                        ...
                        className="px-4 py-2 bg-m2m-accent-teal text-white rounded-lg font-medium hover:bg-m2m-accent-teal/90 transition-all flex items-center gap-2">
            ...
            <motion.div
              ...
              transition={{
                ...
                <div className="space-y-4">
                  ...
                  <div
                    key={doc.id}
                    className="bg-m2m-bg-primary rounded-lg p-4 border border-m2m-divider flex items-center justify-between">

                        <div className="flex items-center gap-4">
                          <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${doc.paid ? 'bg-m2m-success/20' : 'bg-m2m-accent-orange/20'}`}>
                        ...
                        <div className="text-right">
                          <p
                        className={`text-lg font-bold ${doc.paid ? 'text-m2m-success' : 'text-m2m-accent-orange'}`}>
            ...
            <motion.div
              ...
              transition={{
                ...
                <div
                  key={doc.id}
                  className="bg-m2m-bg-primary rounded-lg p-6 border border-m2m-divider">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        {doc.paid ?
                    <span className="px-3 py-1 bg-m2m-success/20 text-m2m-success rounded-full text-sm font-semibold">
                            Completed
                          </span> :

                    <span className="px-3 py-1 bg-m2m-accent-orange/20 text-m2m-accent-orange rounded-full text-sm font-semibold">
                            In Progress
                          </span>
                    }
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2 flex-1">
                          <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center ${doc.paid ? 'bg-m2m-success' : 'bg-m2m-accent-orange'}`}>
                        ...
                        <ClockIcon className="w-5 h-5 text-white" />
                          ...
                          <div
                        className={`flex-1 h-1 ${doc.paid ? 'bg-m2m-success' : 'bg-gray-300'}`}>
                      </div>
                        </div>
                        <div className="flex items-center gap-2 flex-1">
                          <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center ${doc.paid ? 'bg-m2m-success' : 'bg-gray-300'}`}>
