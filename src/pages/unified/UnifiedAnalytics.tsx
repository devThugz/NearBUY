...
export default function UnifiedAnalytics() {
  ...
  const aiRecommendations = [
  {
    ...
    confidence: 94,
    reason:
    'High construction activity detected. Hardware demand increasing by 35%.',
  ...
  },
  {
    ...
    confidence: 82,
    reason:
    'Consistent low demand for 6 months. Storage cost exceeds profit.',
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-m2m-bg-card border border-m2m-divider rounded-lg p-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${timeRange === 'daily' ? 'bg-m2m-accent-blue text-white shadow-lg' : 'text-m2m-text-secondary hover:text-m2m-text-primary'}`}>

                Daily
              </button>
              <button
                onClick={() => setTimeRange('weekly')}
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${timeRange === 'weekly' ? 'bg-m2m-accent-blue text-white shadow-lg' : 'text-m2m-text-secondary hover:text-m2m-text-primary'}`}>

                Weekly
              </button>
              <button
                onClick={() => setTimeRange('monthly')}
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${timeRange === 'monthly' ? 'bg-m2m-accent-blue text-white shadow-lg' : 'text-m2m-text-secondary hover:text-m2m-text-primary'}`}>
            ...
            <select
              ...
              className="px-4 py-2 bg-m2m-bg-card border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue">
            ...
            className="bg-m2m-bg-primary rounded-lg p-5 border border-m2m-divider hover:border-m2m-accent-blue transition-all">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span
                  className={`font-semibold ${location.risk === 'Low' ? 'text-m2m-success' : location.risk === 'Medium' ? 'text-m2m-chart-yellow' : 'text-red-600'}`}>
            ...
            <div
              ...
              className="bg-m2m-bg-primary rounded-lg p-4 border border-m2m-divider">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                  className={`px-2 py-1 text-xs font-bold rounded-full border ${getStatusColor(stock.status)}`}>
                ...
                <div className="w-full h-2 bg-m2m-divider rounded-full overflow-hidden">
                  <div
                  className={`h-full rounded-full ${stock.status === 'safe' ? 'bg-m2m-success' : stock.status === 'low' ? 'bg-m2m-chart-yellow' : 'bg-red-600'}`}
                  style={{
                ...
                <button className="text-xs text-m2m-accent-blue hover:underline">
                      Restock Now
                    </button>
                }
                </div>
        ...
        <motion.div
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              ...
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-m2m-success/10 rounded-lg border border-m2m-success/20">
      ...
      <motion.div
        ...
        <div className="bg-m2m-bg-primary rounded-lg p-4 border border-m2m-divider">
          ...
          <div className="h-48 flex items-end justify-between gap-2">
            {[65, 78, 82, 88, 75, 92, 95].map((height, index) =>
            ...
            <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                    className={`text-xs font-semibold ${segment.trend.startsWith('+') ? 'text-m2m-success' : 'text-red-600'}`}>
          ...
          <motion.div
            ...
            className="bg-m2m-bg-card rounded-lg p-5 border border-m2m-divider hover:border-m2m-accent-blue transition-all">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  {rec.type === 'expand' &&
                <TargetIcon className="w-5 h-5 text-m2m-accent-blue" />
                }
                  {rec.type === 'product' &&
                <PackageIcon className="w-5 h-5 text-m2m-accent-teal" />
                }
                  {rec.type === 'remove' &&
                <AlertTriangleIcon className="w-5 h-5 text-m2m-accent-orange" />
                }
                  {rec.type === 'supplier' &&
                <TruckIcon className="w-5 h-5 text-m2m-success" />
                }
                  <h3 className="font-semibold text-m2m-text-primary text-sm">
                    {rec.title}
                  </h3>
            ...
            className={`p-4 rounded-lg border ${getSeverityColor(alert.severity)}`}>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <AlertCircleIcon className="w-5 h-5 text-m2m-chart-yellow" />
                  }
                    {alert.severity === 'low' &&
                  <AlertCircleIcon className="w-5 h-5 text-blue-700" />
                  }
                  </div>
                  <div>
