        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${filter === 'all' ? 'bg-m2m-accent-blue text-white shadow-lg' : 'bg-m2m-bg-primary text-m2m-text-secondary hover:bg-m2m-accent-blue/10'}`}>

              All ({notifications.length})
            </button>
            <button
              onClick={() => setFilter('unread')}
              className={`px-4 py-2 rounded-lg font-medium transition-all ${filter === 'unread' ? 'bg-m2m-accent-orange text-white shadow-lg' : 'bg-m2m-bg-primary text-m2m-text-secondary hover:bg-m2m-accent-orange/10'}`}>

              Unread ({unreadCount})
            </button>
            <button
              onClick={() => setFilter('read')}
              className={`px-4 py-2 rounded-lg font-medium transition-all ${filter === 'read' ? 'bg-m2m-success text-white shadow-lg' : 'bg-m2m-bg-primary text-m2m-text-secondary hover:bg-m2m-success/10'}`}>
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="px-4 py-2 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue">
          ...
          <div className="flex gap-2">
            <motion.button
              ...
              className="px-4 py-2 bg-m2m-accent-teal text-white rounded-lg font-medium hover:bg-m2m-accent-teal/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
          ...
          <motion.div
            ...
            className={`bg-m2m-bg-card rounded-xl p-6 border transition-all duration-300 ${alert.unread ? 'border-m2m-accent-blue bg-blue-50 shadow-lg' : 'border-m2m-divider hover:border-m2m-accent-blue/50'}`}>
                ...
                <div className="flex items-start gap-4">
                  {/* Icon */}
                  <div
                className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${getAlertColor(alert.type)}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4 mb-2">
                      ...
                      <motion.div
                        ...
                        <p
                      className={`text-sm ${alert.unread ? 'text-m2m-text-primary font-semibold' : 'text-m2m-text-secondary'}`}>
                    ...
                    <motion.button
                      ...
                      className="p-2 hover:bg-m2m-success/20 rounded-lg transition-colors"
                      title="Mark as read">
