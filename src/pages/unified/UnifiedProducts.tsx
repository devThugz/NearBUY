...
// Retail & Shopping Supplies (7 products)
{
  ...
  description:
  'Eco-friendly reusable shopping bags made from durable recycled materials.',
  price: 450,
...
const INITIAL_FEEDBACK: Feedback[] = [
{
  ...
  rating: 5,
  comment:
  'Excellent quality bags! Very durable and perfect for our retail store.',
  date: '2024-01-15',
  helpful: 12,
...
export default function UnifiedProducts() {
  const [activeTab, setActiveTab] = useState<
    'products' | 'cart' | 'orders' | 'history' | 'favorites'>(
    'products');
  ...
  useCart();
  const { orders, addOrder } = useSupplierOrders();
  ...
  const applyVoucher = () => {
    const discount =
    VOUCHERS[voucherCode.toUpperCase() as keyof typeof VOUCHERS];
    if (discount) {
      setAppliedVoucher({
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <motion.button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center relative overflow-hidden ${activeTab === 'products' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-md' : 'bg-m2m-bg-card text-m2m-text-secondary hover:bg-m2m-bg-primary/50 border border-m2m-divider'}`}>

            {activeTab === 'products' &&
            <motion.div
              layoutId="activeTab"
              className="absolute inset-0 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal"
              initial={false}
              transition={{
                type: 'spring',
                stiffness: 500,
          ...
          <motion.button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center relative overflow-hidden ${activeTab === 'cart' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal shadow-md' : 'bg-m2m-bg-card hover:bg-m2m-bg-primary/50 border border-m2m-divider'}`}>
            ...
            <ShoppingCartIcon
              className={`w-5 h-5 mr-2 relative z-10 ${activeTab === 'cart' ? 'text-white' : 'text-m2m-text-secondary'}`} />

            <span
              className={`relative z-10 ${activeTab === 'cart' ? 'text-white' : 'text-m2m-text-secondary'}`}>
          ...
          <motion.button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center relative overflow-hidden ${activeTab === 'favorites' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-md' : 'bg-m2m-bg-card text-m2m-text-secondary hover:bg-m2m-bg-primary/50 border border-m2m-divider'}`}>
            ...
            {favorites.length > 0 &&
            <span className="ml-2 px-2 py-0.5 bg-white/20 rounded-full text-xs relative z-10">
                {favorites.length}
              </span>
            }
          </motion.button>
          <motion.button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center relative overflow-hidden ${activeTab === 'orders' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-md' : 'bg-m2m-bg-card text-m2m-text-secondary hover:bg-m2m-bg-primary/50 border border-m2m-divider'}`}>
          ...
          <motion.button
            ...
            className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center relative overflow-hidden ${activeTab === 'history' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-md' : 'bg-m2m-bg-card text-m2m-text-secondary hover:bg-m2m-bg-primary/50 border border-m2m-divider'}`}>
          ...
          <div className="space-y-4 mb-6">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                className="w-full pl-10 pr-4 py-3 border border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-2xl focus:ring-2 focus:ring-m2m-accent-blue transition-all" />

              </div>
              <div className="relative sm:w-64">
                <button
                onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                className="w-full pl-4 pr-10 py-3 border border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-2xl focus:ring-2 focus:ring-m2m-accent-blue transition-all text-left flex items-center justify-between">
      ...
      <motion.div
        ...
        <div className="bg-m2m-bg-card rounded-xl shadow-lg p-12 text-center border border-m2m-divider">
            ...
            onClick={() => setActiveTab('products')}
            className="px-6 py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-lg font-semibold">
        ...
        <div className="space-y-6">
              <div className="bg-m2m-bg-card rounded-xl shadow-lg p-4 border border-m2m-divider flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  <input
                type="checkbox"
                checked={selectedCartItems.length === items.length}
                onChange={toggleSelectAll}
                className="w-5 h-5 rounded border-m2m-divider text-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue cursor-pointer" />
            ...
            <span className="text-sm text-m2m-accent-blue font-semibold">
            ...
            <motion.div
              ...
              className="bg-m2m-bg-card rounded-xl shadow-lg overflow-hidden border border-m2m-divider">
                  ...
                  className="w-5 h-5 rounded border-m2m-divider text-m2m-accent-blue focus:ring-2 focus:ring-m2m-accent-blue cursor-pointer flex-shrink-0" />
                  ...
                  className="w-24 h-24 object-cover rounded-lg flex-shrink-0" />
                      ...
                      className="w-8 h-8 flex items-center justify-center bg-m2m-bg-primary rounded-lg hover:bg-m2m-divider transition-colors">
                    ...
                    className="mt-2 p-2 text-m2m-accent-orange hover:bg-m2m-accent-orange/10 rounded-lg transition-colors">
            ...
            className="bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider sticky bottom-0">
              ...
              className={`w-full py-4 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 ${selectedCartItems.length > 0 ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white hover:shadow-xl' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`}>
      ...
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            className="bg-m2m-bg-card rounded-xl shadow-lg p-6 border border-m2m-divider cursor-pointer hover:border-m2m-accent-blue transition-all">
      ...
      <motion.div
        ...
        onClick={() => setSelectedProduct(null)}>
          ...
          className="bg-m2m-bg-card rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border-2 border-m2m-divider p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 py-6 border-y border-m2m-divider">
                ...
                <div className="text-center">
                  ...
                  <motion.p
                  key={getAvailableStock(selectedProduct.id)}
                  initial={{
                    scale: 1.2
                  }}
                  animate={{
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  className="w-10 h-10 bg-m2m-bg-primary rounded-lg font-bold hover:bg-m2m-divider transition-colors flex items-center justify-center">
                  ...
                  className="w-20 text-center border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg py-2 font-semibold"
                  min="1"
                  max={getAvailableStock(selectedProduct.id)} />
              ...
              <div className="flex gap-3">
                ...
                className="flex-1 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-bold text-lg hover:shadow-2xl transition-all flex items-center justify-center gap-3">
                ...
                className="flex-1 py-4 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-bold text-lg hover:shadow-2xl transition-all flex items-center justify-center gap-3">
              ...
              <div className="border-t border-m2m-divider pt-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <StarIcon
                      key={i}
                      className={`w-5 h-5 ${i < Math.floor(getAverageRating(selectedProduct.id)) ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}`} />
                ...
                <div className="space-y-4 mb-4">
                  {getProductFeedback(selectedProduct.id).
                  ...
                  className={`p-4 rounded-xl border ${feedback.isVerifiedBusiness ? 'bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5 border-m2m-accent-blue/20' : 'bg-m2m-bg-primary border-m2m-divider'}`}>
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            {feedback.isVerifiedBusiness &&
                      <div className="flex items-center gap-1 px-2 py-0.5 bg-m2m-accent-blue/20 rounded-full">
                    ...
                    className={`flex items-center gap-2 text-sm ${helpfulClicks[feedback.id] ? 'text-m2m-accent-blue' : 'text-m2m-text-secondary hover:text-m2m-accent-blue'} transition-colors`}>

                          <ThumbsUpIcon
                      className={`w-4 h-4 ${helpfulClicks[feedback.id] ? 'fill-m2m-accent-blue' : ''}`} />
                ...
                {getProductFeedback(selectedProduct.id).length > 2 &&
              <motion.button
                whileHover={{
                  scale: 1.02
                }}
                ...
                className="w-full py-3 border-2 border-m2m-divider rounded-xl font-semibold text-m2m-accent-blue hover:bg-m2m-accent-blue/10 transition-all flex items-center justify-center gap-2">
                ...
                className="w-full mt-4 py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-semibold hover:shadow-xl transition-all flex items-center justify-center gap-2">
                ...
                <motion.div
                  ...
                  className="mt-4 p-6 bg-m2m-bg-primary rounded-xl border border-m2m-divider">
                      ...
                      <div className="space-y-4">
                        ...
                        className="w-full px-4 py-3 border border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-xl focus:ring-2 focus:ring-m2m-accent-blue" />
                        ...
                        <motion.button
                          ...
                          className="p-1">
                                ...
                                <StarIcon
                            className={`w-8 h-8 ${star <= newFeedback.rating ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}`} />
                        ...
                        rows={4}
                        className="w-full px-4 py-3 border border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-xl focus:ring-2 focus:ring-m2m-accent-blue resize-none" />
                        ...
                        className="flex-1 py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-semibold hover:shadow-xl transition-all">
          ...
          className="bg-m2m-bg-card rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] border-2 border-m2m-divider flex flex-col">
            ...
            <div className="p-8 border-b border-m2m-divider flex-shrink-0">
              <div className="flex justify-between items-center">
                ...
                className="p-2 hover:bg-m2m-bg-primary rounded-xl transition-colors">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    className="text-sm text-m2m-accent-blue hover:text-m2m-accent-teal font-medium flex items-center gap-1 px-3 py-2 border border-m2m-accent-blue rounded-lg hover:bg-m2m-accent-blue/10 transition-all">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    placeholder="Enter voucher code (e.g., SAVE50)"
                    className="flex-1 px-4 py-3 border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-xl focus:ring-2 focus:ring-m2m-accent-blue" />
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-semibold hover:shadow-lg">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center p-4 border-2 border-m2m-divider rounded-xl cursor-pointer hover:border-m2m-accent-blue transition-colors">
                      ...
                      name="payment"
                      value="gcash"
                      checked={checkoutData.paymentMethod === 'gcash'}
                      onChange={(e) =>
                      setCheckoutData({
                        ...checkoutData,
                        paymentMethod: e.target.value
                ...
                <motion.div
                key={`${selectedTotal}-${discountAmount}`}
                initial={{
                  opacity: 0.8
                }}
                animate={{
            ...
            <div className="p-8 border-t border-m2m-divider flex-shrink-0">
              ...
              className="w-full py-4 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-bold text-lg hover:shadow-xl transition-all">
          ...
          className="bg-m2m-bg-card rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border-2 border-m2m-divider p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                className="w-full px-4 py-3 border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-xl focus:ring-2 focus:ring-m2m-accent-blue" />
              ...
              <div>
                ...
                placeholder="Unit number, floor (optional)"
                className="w-full px-4 py-3 border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-xl focus:ring-2 focus:ring-m2m-accent-blue" />
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex-1 flex items-center justify-center p-4 border-2 border-m2m-divider rounded-xl cursor-pointer hover:border-m2m-accent-blue transition-colors">
                    ...
                    name="category"
                    value="Home"
                    checked={currentAddress.category === 'Home'}
                    onChange={(e) =>
                    setCurrentAddress({
                      ...currentAddress,
                  ...
                  <label className="flex-1 flex items-center justify-center p-4 border-2 border-m2m-divider rounded-xl cursor-pointer hover:border-m2m-accent-blue transition-colors">
                    ...
                    name="category"
                    value="Office"
                    checked={currentAddress.category === 'Office'}
                    onChange={(e) =>
                    setCurrentAddress({
                      ...currentAddress,
                      category: e.target.value as 'Home' | 'Office'
          ...
          className="bg-m2m-bg-card rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] border-2 border-m2m-divider flex flex-col">
            ...
            <div className="p-8 border-t border-m2m-divider flex-shrink-0">
              <div className="flex gap-4">
                ...
                className="flex-1 py-4 border-2 border-m2m-accent-blue text-m2m-accent-blue rounded-xl font-bold hover:bg-m2m-accent-blue/10 transition-all flex items-center justify-center gap-2">
                ...
                className="flex-1 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-bold hover:shadow-xl transition-all flex items-center justify-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-m2m-bg-primary p-4 rounded-xl">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="font-bold text-m2m-text-primary">
                    {getDeliveryDate(
                    selectedOrderDetails.deliveryOption || 'standard'
                  )}
                  </p>
                  {getWeatherIcon(
                  selectedOrderDetails.deliveryOption || 'standard'
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-m2m-text-primary mt-4">
                  ₱
                  {(
                selectedOrderDetails.price * selectedOrderDetails.quantity).
                toFixed(2)}
                </p>
              </div>
            </div>
            ...
            className="bg-m2m-bg-card rounded-2xl shadow-2xl max-w-md w-full p-6 border border-m2m-divider">
              ...
              <div className="text-center">
                ...
                <div className="flex gap-3">
                  ...
                  onClick={cancelDelete}
                  className="flex-1 px-4 py-3 border-2 border-m2m-divider rounded-lg font-semibold text-m2m-text-primary hover:bg-m2m-bg-primary transition-all">
                  ...
                  className="flex-1 px-4 py-3 bg-m2m-accent-orange text-white rounded-lg font-semibold hover:brightness-110 transition-all">
