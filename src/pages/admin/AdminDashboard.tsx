...
export default function AdminDashboard() {
  ...
  const { userLocations } = useLocationSharing();
  ...
  useEffect(() => {
    const notificationTypes = [
    {
      type: 'user' as const,
      messages: [
      'New user login: Maria Santos just logged in',
      'New user registration: Juan Dela Cruz',
      'User profile updated: Tech Solutions Inc.'],
    ...
    },
    {
      ...
      messages: [
      'New supplier registration: Fresh Valley Farms',
      'Supplier updated product catalog: BuildMart Hardware',
    ...
    },
    {
      ...
      messages: [
      'Document status changed: Approved',
      'New document uploaded by Green Valley Farms',
  ...
  const businessUsers: BusinessUser[] = userLocations.
  filter((loc) => loc.userType === 'business').
  map((loc) => ({
    id: loc.userId,
    name: loc.userName,
  ...
  const supplierUsers: SupplierUser[] = userLocations.
  filter((loc) => loc.userType === 'supplier').
  map((loc) => ({
    id: loc.userId,
    name: loc.userName,
  ...
  const tandagZones = [
  {
    ...
    area: '2.5 km²',
    regulations:
    'Commercial activities permitted. Building height limit: 10 floors.'
  },
  {
    id: 2,
  ...
  const filteredDocuments = documentSubmissions.filter((doc) => {
    const matchesSearch =
    doc.user.toLowerCase().includes(documentSearchQuery.toLowerCase()) ||
    doc.documentType.toLowerCase().includes(documentSearchQuery.toLowerCase());
    const matchesStatus =
    documentStatusFilter === 'all' ||
    doc.status.toLowerCase() === documentStatusFilter.toLowerCase();
    const matchesUser =
    documentUserFilter === 'all' ||
    doc.userType.toLowerCase() === documentUserFilter.toLowerCase();
  ...
  const faqs = [
  {
    ...
    answer:
    'Navigate to the Smart Users section, find pending users, and click the "Approve" button. You can review their documents before approval.'
  },
  {
    question: 'How to manage supplier documents?',
    answer:
    'Go to the Documents tab, filter by supplier, and you can view, approve, or request revisions for submitted documents.'
  },
  {
    question: 'How to reset my password?',
    answer:
    'Click on Profile, then navigate to the Security section and click "Change Password". Enter your current password and new password.'
  }];
  ...
  return (
    <div className="min-h-screen bg-m2m-bg-primary">
      {/* Fixed Sidebar - Desktop */}
      <aside
        className={`hidden lg:flex fixed left-0 top-0 bottom-0 bg-m2m-bg-card border-r border-m2m-divider shadow-xl z-40 flex-col transition-all duration-300 ease-in-out ${sidebarCollapsed ? 'w-20' : 'w-72'}`}>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5 relative">
            ...
            <div className="flex items-center space-x-3">
                ...
                src="/Gemini_Generated_Image_gkv9vygkv9vygkv9.png"
                alt="NEARBUY Logo"
            ...
            <motion.img
              ...
              src="/Gemini_Generated_Image_gkv9vygkv9vygkv9.png"
              alt="NEARBUY Logo"
              className="w-10 h-10 rounded-xl shadow-lg mx-auto" />
            ...
            <motion.button
              ...
              className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 bg-m2m-accent-blue rounded-full flex items-center justify-center shadow-lg hover:bg-m2m-accent-teal transition-colors">
            ...
            {navItems.map((item) => {
              ...
              return (
                <motion.button
                  ...
                  className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center px-3' : 'justify-start space-x-3 px-4'} py-3.5 rounded-xl transition-all ${isActive ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-lg shadow-m2m-accent-blue/30' : 'text-m2m-text-secondary hover:bg-gradient-to-r hover:from-m2m-accent-blue/10 hover:to-m2m-accent-teal/10 hover:text-m2m-text-primary'} group relative`}
                  title={sidebarCollapsed ? item.label : undefined}>

                  <Icon
                    className={`w-5 h-5 flex-shrink-0 transition-transform ${isActive ? 'scale-110' : 'group-hover:scale-110'}`} />
                  ...
                  <div className="absolute left-full ml-2 px-3 py-2 bg-m2m-bg-card border border-m2m-divider rounded-lg shadow-xl opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50">
          ...
          <div className="p-4 border-t border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
            ...
            <motion.div
              ...
              className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center mx-auto shadow-lg cursor-pointer"
        ...
        <>
            ...
            className="fixed left-0 top-0 bottom-0 w-72 bg-m2m-bg-card shadow-2xl z-50 flex flex-col lg:hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-m2m-divider">
                ...
                <button
                onClick={() => setSidebarOpen(false)}
                className="p-2 hover:bg-m2m-bg-primary rounded-lg">
      ...
      {/* Main Content */}
      <div
        className={`min-h-screen flex flex-col transition-all duration-300 ease-in-out ${sidebarCollapsed ? 'lg:ml-20' : 'lg:ml-72'}`}>
        ...
        <header className="bg-m2m-bg-card border-b border-m2m-divider sticky top-0 z-30 shadow-sm">
          <div className="flex items-center justify-between px-4 lg:px-6 py-4">
            <button
              ...
              className="lg:hidden p-2 hover:bg-m2m-bg-primary rounded-xl transition-colors">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <motion.button
                  ...
                  className="p-2.5 hover:bg-m2m-bg-primary rounded-xl relative transition-colors"
                  title="View Alerts">
              ...
              <div className="relative">
                <motion.button
                  ...
                  className="flex items-center space-x-2 p-1.5 hover:bg-m2m-bg-primary rounded-xl transition-colors group">

                  <div className="relative">
                    <img
                      src={userProfilePhoto}
                      alt={user?.name || 'Admin'}
                      className="w-10 h-10 rounded-full object-cover border-2 border-m2m-divider group-hover:border-m2m-accent-blue transition-colors shadow-md" />
                      ...
                      className="absolute right-0 mt-2 w-64 bg-m2m-bg-card border border-m2m-divider rounded-2xl shadow-2xl z-50 py-2 overflow-hidden">
                        ...
                        <div className="px-4 py-3 border-b border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
                          <div className="flex items-center space-x-3">
                            ...
                            src={userProfilePhoto}
                            alt={user?.name || 'Admin'}
                            className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-md" />
                        ...
                        <div className="py-2">
                          ...
                          return (
                            <motion.button
                              ...
                              onClick={item.action}
                              className={`w-full flex items-center space-x-3 px-4 py-2.5 transition-all ${item.danger ? 'text-m2m-accent-orange hover:bg-m2m-accent-orange/10' : 'text-m2m-text-secondary hover:bg-m2m-bg-primary hover:text-m2m-text-primary'}`}>
          ...
          <div className="p-4 lg:p-8 max-w-7xl mx-auto">
            ...
            <div className="space-y-6">
                ...
                className="bg-m2m-bg-card rounded-2xl shadow-lg p-6 border border-m2m-divider">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      <div className="flex items-center space-x-3 bg-m2m-bg-primary px-4 py-2 rounded-lg">
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          checked={showBusinessUsers}
                          onChange={(e) =>
                          setShowBusinessUsers(e.target.checked)
                          } />
                      ...
                      <div className="flex items-center space-x-3 bg-m2m-bg-primary px-4 py-2 rounded-lg">
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          type="checkbox"
                          className="sr-only peer"
                          checked={showSupplierUsers}
                          onChange={(e) =>
                          setShowSupplierUsers(e.target.checked)
                          } />
                      ...
                      <div className="relative">
                        ...
                        className="pl-10 pr-4 py-2 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />
                  ...
                  <div
                  className="rounded-lg overflow-hidden shadow-md border border-m2m-divider"
                  style={{
                    height: '500px'
                  }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  className="bg-m2m-bg-card rounded-2xl shadow-lg p-6 border border-m2m-divider">
                    ...
                    <div className="space-y-4 max-h-[600px] overflow-y-auto">
                      {filteredSupplierUsers.map((user, index) =>
                    <motion.div
                      key={user.id}
                      initial={{
                        opacity: 0,
            ...
            <motion.div
              ...
              className="space-y-6">
                ...
                <div className="bg-m2m-bg-card rounded-2xl shadow-lg p-6 border border-m2m-divider">
                  <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      className="flex items-center space-x-2 px-4 py-2.5 bg-m2m-accent-blue text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                      ...
                      className="flex items-center space-x-2 px-4 py-2.5 bg-m2m-accent-orange text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <div className="divide-y divide-m2m-divider">
                    ...
                    <motion.div
                      ...
                      className={`p-6 hover:bg-m2m-bg-primary/50 transition-all duration-300 cursor-pointer ${alert.unread ? 'bg-blue-50/50' : ''}`}
                          ...
                          className="mt-1 flex-shrink-0">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between mb-2">
                                  <p
                              className={`text-sm font-medium ${alert.unread ? 'text-m2m-text-primary' : 'text-m2m-text-secondary'}`}>
                            ...
                            <motion.div
                              ...
                              className="w-2.5 h-2.5 bg-red-500 rounded-full ml-3 mt-1 flex-shrink-0" />
                                ...
                                <div className="flex items-center space-x-3">
                                  ...
                                  <span
                              className={`text-xs px-2 py-1 rounded-full font-medium ${getAlertCategoryColor(alert.type)}`}>

                                    {alert.type.charAt(0).toUpperCase() +
                              alert.type.slice(1)}
                                  </span>
                                  <span
                              className={`text-xs px-2 py-1 rounded-full font-medium ${alert.unread ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700'}`}>
                ...
                className="bg-m2m-bg-card rounded-2xl shadow-lg p-6 border border-m2m-divider">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div className="relative">
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />

                    </div>
                    <select
                    value={documentStatusFilter}
                    onChange={(e) => setDocumentStatusFilter(e.target.value)}
                    className="px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue transition-colors">
                    ...
                    <select
                    value={documentUserFilter}
                    onChange={(e) => setDocumentUserFilter(e.target.value)}
                    className="px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue transition-colors">
                    ...
                    <select
                    value={documentMethodFilter}
                    onChange={(e) => setDocumentMethodFilter(e.target.value)}
                    className="px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-lg text-m2m-text-primary focus:outline-none focus:border-m2m-accent-blue transition-colors">
                    ...
                    className="px-4 py-3 bg-m2m-accent-orange text-white rounded-lg font-medium hover:shadow-lg transition-all flex items-center justify-center space-x-2">
                      ...
                      <motion.tr
                        ...
                        className="transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              src={doc.avatar}
                              alt={doc.user}
                              className="w-10 h-10 rounded-full object-cover border-2 border-m2m-divider" />
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              className="p-2 bg-m2m-accent-blue/10 text-m2m-accent-blue rounded-lg hover:bg-m2m-accent-blue hover:text-white transition-all"
                              title="View">
                              ...
                              className="p-2 bg-m2m-accent-teal/10 text-m2m-accent-teal rounded-lg hover:bg-m2m-accent-teal hover:text-white transition-all"
                              title="Download">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  className="lg:col-span-2 bg-m2m-bg-card rounded-2xl shadow-lg border border-m2m-divider overflow-hidden">
                    ...
                    <div className="p-4 border-b border-m2m-divider flex items-center justify-between">
                      ...
                      onClick={() => setShowZoneLegend(!showZoneLegend)}
                      className="px-3 py-1.5 bg-m2m-accent-blue text-white rounded-lg text-sm font-medium hover:shadow-lg transition-all">
                      ...
                      zoomControl={false}>
                        ...
                        return (
                          <Fragment key={zone.id}>
                              ...
                              <Marker
                              position={[
                              (zone.bounds[0][0] + zone.bounds[2][0]) / 2,
                              (zone.bounds[0][1] + zone.bounds[2][1]) / 2]
                              }
                              icon={
                              new Icon({
                                iconUrl: `data:image/svg+xml;base64,${btoa(`
                    ...
                    className="space-y-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="p-3 bg-m2m-bg-primary rounded-lg">
                            ...
                            <span
                          className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${selectedZone.hazardLevel === 'High' ? 'bg-red-500/20 text-red-500' : selectedZone.hazardLevel === 'Medium' ? 'bg-m2m-chart-yellow/20 text-m2m-chart-yellow' : 'bg-m2m-success/20 text-m2m-success'}`}>
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              <div className="w-full max-w-[600px] max-h-[90vh] bg-m2m-bg-card rounded-2xl shadow-2xl border border-m2m-divider overflow-hidden flex flex-col">
                  ...
                  className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        disabled
                        className="w-full pl-10 pr-4 py-3 border border-m2m-divider bg-m2m-bg-primary/50 text-m2m-text-secondary rounded-lg cursor-not-allowed" />
                ...
                className="flex gap-3 p-6 border-t border-m2m-divider bg-m2m-bg-primary flex-shrink-0">
                  ...
                  className="flex-1 flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-[#2563EB] to-[#00B3A4] text-white rounded-lg font-semibold shadow-lg transition-all">
                  ...
                  onClick={() => setActiveDrawer(null)}
                  className="px-6 py-3 border-2 border-m2m-divider text-m2m-text-secondary rounded-lg font-semibold hover:bg-m2m-bg-card transition-all">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        ...
                        <motion.div
                          ...
                          className="flex items-center justify-between p-4 bg-m2m-bg-primary rounded-lg border border-m2m-divider hover:border-[#2563EB] transition-all duration-300">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                              ...
                              checked={
                              settingsData[
                              item.key as keyof typeof settingsData] as
                              boolean
                              }
                              onChange={(e) =>
                              setSettingsData({
                  ...
                  className="space-y-4">
                    ...
                    className="flex items-center justify-between p-4 bg-m2m-bg-primary rounded-lg border border-m2m-divider">
                      ...
                      <SunIcon className="w-5 h-5 text-[#FB923C]" />
                      }
                        <span className="font-medium text-m2m-text-primary">
                          Light / Dark Mode
                        </span>
                    ...
                    <div className="p-4 bg-m2m-bg-primary rounded-lg border border-m2m-divider space-y-3">
                      ...
                      <div className="flex gap-3">
                        ...
                        className={`w-12 h-12 rounded-full bg-[#FB923C] flex items-center justify-center transition-all ${settingsData.accentColor === 'orange' ? 'ring-4 ring-[#FB923C]/30' : ''}`}>
                          ...
                          {settingsData.accentColor === 'orange' &&
                        <CheckCircle2Icon className="w-6 h-6 text-white" />
                        }
                        </motion.button>
                      </div>
                  ...
                  className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                        type="text"
                        value={settingsData.cloudStorage}
                        onChange={(e) =>
                        setSettingsData({
                          ...settingsData,
                        ...
                        placeholder="Enter Cloud Storage URL"
                        className="w-full pl-10 pr-4 py-3 border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-[#2563EB] focus:border-[#2563EB] transition-all" />
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                  ...
                  className="space-y-4">
                    ...
                    <div className="p-4 bg-m2m-bg-primary rounded-lg border border-m2m-divider space-y-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <a
                        href="mailto:support@nearbuy.com"
                        className="text-m2m-text-primary hover:text-[#2563EB] transition-colors">
                  ...
                  className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      rows={4}
                      className="w-full px-4 py-3 border border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-[#2563EB] focus:border-[#2563EB] transition-all resize-none" />
                      ...
                      className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-[#2563EB] to-[#00B3A4] text-white rounded-lg font-semibold shadow-lg transition-all">
