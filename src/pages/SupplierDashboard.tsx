          ...
          <motion.div
            ...
            className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                className={`text-sm font-semibold ${card.change.startsWith('+') ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 relative">
            <motion.div
              ...
              className="lg:fixed lg:top-24 lg:w-[calc((100%-8rem)*2/3-1rem)] bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/30 overflow-hidden"
              style={{
                maxWidth: '100%'
              }}>
                ...
                <div className="px-6 py-4 bg-white border-b border-gray-200 flex-shrink-0">
                  <div className="flex flex-wrap gap-3">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'zone' ? 'bg-gradient-to-r from-[#0052D4] to-[#FF6A00] text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>

                      Zone Info
                    </button>
                    <button
                      onClick={() => setActiveMapView('businesses')}
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'businesses' ? 'bg-gradient-to-r from-[#0052D4] to-[#FF6A00] text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>

                      Nearby Businesses
                    </button>
                    <button
                      onClick={() => setActiveMapView('ai')}
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'ai' ? 'bg-gradient-to-r from-[#0052D4] to-[#FF6A00] text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                          ...
                          weight: 2
                            ...
                            <Popup>
                              <div className="p-2 min-w-[200px]">
                                ...
                                {zone.aiScore > 0 && activeMapView === 'ai' &&
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <motion.div
              ...
              <div className="space-y-3">
                ...
                <div
                  key={index}
                  className="bg-gradient-to-br from-white to-gray-50 rounded-xl p-4 border border-gray-200 hover:shadow-lg transition-all">
            ...
            <motion.div
              ...
              <div className="space-y-4">
                {swotData.slice(0, 2).map((item, index) =>
                <div
                  key={index}
                  className={`bg-gradient-to-br ${item.color} rounded-xl p-4 border border-white/20`}>
                    ...
                    <ul className="space-y-1">
                      {item.items.slice(0, 2).map((point, i) =>
                    <li
                      key={i}
              ...
              className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-6 border border-white/20">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="w-20 h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div
                    className="h-full bg-gradient-to-r from-[#0052D4] to-[#FF6A00]"
                    style={{
                      width: '75%'
                    }}>
                  </div>
