      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <form
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-blue-900 to-orange-500 text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center">
            ...
            <div className="relative aspect-video bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-30">
                <div
                  ...
                  style={{
                    backgroundImage:
                    'radial-gradient(circle at 20% 50%, rgba(59, 130, 246, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(249, 115, 22, 0.3) 0%, transparent 50%)'
                  }}>
                </div>
              </div>
              {/* Map markers */}
