...
export default function SupplierCart() {
  ...
  const { addOrder } = useSupplierOrders();
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-12 text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-blue-900 to-orange-500 text-white rounded-lg font-semibold hover:shadow-lg transition-all">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-lg p-6 sticky top-24">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-blue-900 to-orange-500 text-white rounded-lg font-semibold hover:shadow-lg transition-all">

              Place Order
            </button>
            <button
              onClick={() => navigate('/supplier/products')}
              className="w-full mt-3 py-3 border-2 border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-all">
