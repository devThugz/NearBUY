...
export default function SupplierDashboard() {
  ...
  const supplierInsights = [
  {
    id: 1,
    message:
    'High demand for Premium Rice 25kg in Zone 4. Consider increasing stock.',
    severity: 'high',
    icon: TrendingUpIcon
  },
  {
    id: 2,
    message:
    'Your delivery rate dropped by 6% this week. Suggested action: optimize delivery routes.',
    severity: 'medium',
  ...
  },
  {
    id: 3,
    message:
    'Retailers in your area are frequently running out of Fresh Vegetables. Opportunity detected.',
    severity: 'low',
    icon: StoreIcon
  }];
  ...
  },
  {
    ...
    type: 'business',
    message:
    'New retail business "Fresh Market Pro" registered in your delivery zone',
    time: '45 min ago',
    icon: StoreIcon,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => toast.info('Full insights coming soon!')}
            ...
            <motion.div
              ...
              className="flex items-center justify-between p-3 bg-m2m-bg-primary rounded-lg">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <ArrowUpIcon
                  className={`w-4 h-4 ${item.trend === 'up' ? 'text-m2m-success' : 'text-m2m-accent-orange'}`} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="flex space-x-2">
            <Link
              to="/supplier/orders"
              className="flex-1 px-4 py-2 bg-m2m-accent-blue text-white rounded-lg text-sm font-medium hover:bg-m2m-accent-teal transition-colors text-center">

              Prepare Order
            </Link>
            <button
              onClick={() => toast.info('Print feature coming soon!')}
              className="px-4 py-2 bg-m2m-bg-primary border border-m2m-divider text-m2m-text-primary rounded-lg text-sm font-medium hover:bg-m2m-accent-blue/10 transition-colors flex items-center">
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => toast.info('Customer insights coming soon!')}
              className="text-sm text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors font-medium">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="space-y-2">
            ...
            {supplierInventory.suggestions.map((suggestion, index) =>
            <div
              key={index}
              className="flex items-start space-x-2 p-2 bg-m2m-bg-primary rounded-lg">
        ...
        <motion.div
          ...
          <div className="space-y-3">
            {supplierMarketActivities.map((activity, index) =>
            <motion.div
              key={activity.id}
              initial={{
                opacity: 0,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => toast.info('All alerts coming soon!')}
              className="text-sm text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors font-medium">
        ...
        <motion.div
          ...
          <div className="space-y-2">
            ...
            {supplierPerformance.topSKUs.map((sku, index) =>
            <div
              key={index}
      ...
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <motion.div
            ...
            <Link
              to="/supplier/products"
              className="block p-4 border-2 border-m2m-divider rounded-lg hover:border-m2m-accent-blue hover:bg-m2m-accent-blue/10 transition-all duration-300 ease-in-out hover:shadow-lg">
          ...
          <motion.div
            ...
            <Link
              to="/supplier/cart"
              className="block p-4 border-2 border-m2m-divider rounded-lg hover:border-m2m-accent-orange hover:bg-m2m-accent-orange/10 transition-all duration-300 ease-in-out hover:shadow-lg">
          ...
          <motion.div
            ...
            <Link
              to="/supplier/orders"
              className="block p-4 border-2 border-m2m-divider rounded-lg hover:border-m2m-success hover:bg-m2m-success/10 transition-all duration-300 ease-in-out hover:shadow-lg">
