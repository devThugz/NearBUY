...
export default function BusinessDashboard() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          toast.error(
            'Location access denied — enable location to view nearby suppliers'
          );
        }
      );
    } else {
  ...
  const generateSuppliersForLocation = useCallback(
  ...
  generateSuppliersForLocation(centerPosition)
  );
  ...
  const handleViewProductsInShop = (supplier: Supplier) => {
    ...
    toast.success(
      `Redirecting to shop with ${supplier.name}'s product categories...`
    );
  };
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 relative">
            <motion.div
              ...
              className="lg:sticky lg:top-24 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden"
              style={{
                maxWidth: '100%',
                zIndex: 1
              }}>
              ...
              <div className="flex flex-col h-[600px]">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ...
                        'Click anywhere on the map to discover nearby suppliers'}
                      </p>
                    </div>
                    <motion.div
                      animate={{
                ...
                <div className="px-6 py-4 bg-white border-b border-gray-200 flex-shrink-0">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button
                        onClick={() => setActiveMapView('zone')}
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'zone' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>

                        Zones
                      </button>
                      <button
                        onClick={() => setActiveMapView('suppliers')}
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'suppliers' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>

                        Suppliers
                      </button>
                      <button
                        onClick={() => setActiveMapView('ai')}
                        className={`px-4 py-2 rounded-lg font-medium transition-all ${activeMapView === 'ai' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-wrap gap-3 pt-2 border-t border-gray-200">
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${mapLayerMode === 'street' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${mapLayerMode === 'satellite' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>

                        <SatelliteIcon className="w-4 h-4" />
                        Satellite View
                      </button>
                      <button
                        onClick={() => setMapLayerMode('livetext')}
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all ${mapLayerMode === 'livetext' ? 'bg-blue-600 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                    ...
                    <div className="flex flex-wrap gap-4 pt-2 border-t border-gray-200">
                      <button
                        ...
                        <span
                          className={`text-sm font-medium ${showZoneInfo ? 'text-gray-900' : 'text-gray-500'}`}>
                      ...
                      <button
                        onClick={() => {
                          ...
                          toast.success(
                            showNearbyOperators ?
                            'Nearby Operators hidden' :
                            'Nearby Operators shown'
                          );
                        }}
                        className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all">
                        ...
                        <span
                          className={`text-sm font-medium ${showNearbyOperators ? 'text-gray-900' : 'text-gray-500'}`}>
                      ...
                      <button
                        ...
                        {showAIRecommender ?
                        <ToggleRightIcon className="w-5 h-5 text-purple-600" /> :

                        <ToggleLeftIcon className="w-5 h-5 text-gray-400" />
                        }
                        <span
                          className={`text-sm font-medium ${showAIRecommender ? 'text-gray-900' : 'text-gray-500'}`}>
                ...
                <div className="flex-1 relative overflow-hidden">
                  <div className="absolute inset-0">
                    <MapContainer
                      center={pinnedLocation || centerPosition}
                      zoom={13}
                      ...
                      {pinnedLocation && pinnedLocation !== userLocation &&
                      <Marker
                      ...
                      {showAIRecommender && activeMapView === 'ai' &&
                      <Marker
                        position={[8.97, 125.54]}
            ...
            <AnimatePresence mode="wait">
              ...
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 overflow-hidden">
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div
                    key={nearbySuppliers.map((s) => s.id).join('-')}
                    initial={{
                      opacity: 0,
                      y: 20
                    }}
                    ...
                    <motion.div
                      ...
                      className="bg-gray-50 rounded-xl p-4 border border-gray-200 hover:shadow-md transition-all">
                          ...
                          className="flex-1 px-3 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-all flex items-center justify-center">
                          ...
                          className="flex-1 px-3 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 transition-all flex items-center justify-center">
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-full max-w-5xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6 space-y-8">
                  ...
                  className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                    ...
                    onClick={() => handleViewProductsInShop(selectedSupplier)}
                    className="flex-1 px-6 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out flex items-center justify-center space-x-2">
