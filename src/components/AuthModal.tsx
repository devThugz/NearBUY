...
// Admin credentials kept for login; demo business/supplier accounts removed
...
export default function AuthModal({
  ...
  // No auto-fill for any account type — user enters credentials manually
  useEffect(() => {
        ...
        <div className="p-6 md:p-8">
          <div className="flex justify-end mb-4">
            <motion.button
              ...
              onClick={onClose}
              className="p-2 hover:bg-m2m-bg-primary/50 rounded-lg transition-colors">
          ...
          <AnimatePresence mode="wait">
              ...
              transition={{
                ...
                <form onSubmit={handleLogin} className="space-y-3.5">
                  ...
                  <div>
                    ...
                    className="w-full px-3.5 py-2.5 border-2 border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue transition-all text-sm shadow-sm placeholder-m2m-text-secondary"
                  ...
                  <div>
                    <div className="relative">
                      ...
                      className="w-full px-3.5 py-2.5 border-2 border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue transition-all pr-10 text-sm shadow-sm placeholder-m2m-text-secondary"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <label
                      htmlFor="rememberMe"
                      className="ml-2 text-xs text-m2m-text-secondary">
                    ...
                    className="text-xs text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors font-medium">
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-2.5 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all disabled:opacity-50 flex items-center justify-center text-sm mt-5">
            ...
            <motion.div
              ...
              <>
                    ...
                    className="p-2 hover:bg-m2m-bg-primary/50 rounded-lg transition-colors text-m2m-accent-blue hover:text-m2m-accent-teal">
                    ...
                    <form onSubmit={handleForgotPassword} className="space-y-4">
                      <div>
                        ...
                        className="w-full px-3.5 py-2.5 pl-10 border-2 border-m2m-divider bg-m2m-bg-primary text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue transition-all text-sm shadow-sm placeholder-m2m-text-secondary"
                        placeholder="Enter your email"
                        required />
                    ...
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-2.5 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all disabled:opacity-50 flex items-center justify-center text-sm">
              ...
              <motion.div
                ...
                className="text-center">
                    ...
                    className="text-sm text-m2m-accent-blue hover:text-m2m-accent-teal font-medium transition-colors">
                    ...
                    <button
                  onClick={resetForgotPassword}
                  className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-2.5 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all text-sm">
                ...
                <form onSubmit={handleRegister} className="space-y-3.5">
                  <div>
                    ...
                    <div className="relative">
                        ...
                        src={profilePhoto}
                        alt="Profile"
                        className="w-24 h-24 rounded-full object-cover border-4 border-m2m-accent-blue" />

                          <button
                        type="button"
                        onClick={removePhoto}
                        className="absolute -top-2 -right-2 w-8 h-8 bg-m2m-accent-orange text-white rounded-full flex items-center justify-center hover:bg-red-600 transition-colors shadow-lg">

                            <XIcon className="w-4 h-4" />
                          </button>
                        </div> :

                    <label className="w-24 h-24 bg-m2m-bg-primary border-2 border-dashed border-m2m-divider rounded-full flex flex-col items-center justify-center cursor-pointer hover:border-m2m-accent-blue hover:bg-m2m-accent-blue/5 transition-all group">
                          <input
                        type="file"
                        accept="image/*"
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center transition-all ${registerData.password.length >= 8 ? 'bg-m2m-success' : registerData.password.length > 0 ? 'bg-gray-300' : 'bg-white border-2 border-gray-300'}`}>
                      ...
                      <div className="flex items-center justify-between">
                        <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center transition-all ${/[A-Z]/.test(registerData.password) ? 'bg-m2m-success' : registerData.password.length > 0 ? 'bg-gray-300' : 'bg-white border-2 border-gray-300'}`}>
                      ...
                      <div className="flex items-center justify-between">
                        <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center transition-all ${/[0-9]/.test(registerData.password) ? 'bg-m2m-success' : registerData.password.length > 0 ? 'bg-gray-300' : 'bg-white border-2 border-gray-300'}`}>
