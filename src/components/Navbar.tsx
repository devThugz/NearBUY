      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-6">
            <Link
              to="/"
              className="flex items-center text-gray-600 hover:text-blue-600 transition-colors px-3 py-2 rounded-xl hover:bg-blue-50">
            ...
            <Link
              to="/cart"
              className="relative flex items-center text-gray-600 hover:text-blue-600 transition-colors px-3 py-2 rounded-xl hover:bg-blue-50">
            ...
            <div className="flex items-center space-x-3 pl-6 ml-2 border-l border-gray-200">
                  ...
                  <>
                      ...
                      className="absolute right-0 top-14 w-96 bg-white/95 backdrop-blur-lg border border-gray-200 rounded-2xl shadow-2xl z-50 overflow-hidden">
                        ...
                        <motion.div
                          ...
                          className={`p-4 border-b border-gray-200 hover:bg-gray-50 transition-all duration-300 cursor-pointer group ${alert.unread ? 'bg-blue-50/50' : ''}`}>
                              ...
                              className="mt-1 flex-shrink-0">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <p
                                className={`text-sm font-medium ${alert.unread ? 'text-gray-900' : 'text-gray-600'}`}>
                      ...
                      <div className="p-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                          ...
                          className="flex items-center space-x-2 text-sm text-blue-600 hover:text-teal-600 font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
              ...
              <motion.div
                ...
                className="text-xs text-gray-400 hover:text-gray-600 transition-colors cursor-default hidden lg:block"
                style={{
                  fontSize: '11px',
                  letterSpacing: '0.3px'
                }}>
