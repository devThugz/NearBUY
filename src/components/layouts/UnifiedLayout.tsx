...
import {
  ...
  CheckCheckIcon,
  Trash2Icon,
  HistoryIcon as ViewHistoryIcon,
  AlertCircleIcon,
...
export default function UnifiedLayout() {
  ...
  const [safeBizMessages, setSafeBizMessages] = useState<SafeBizMessage[]>([
  {
    ...
    type: 'assistant',
    content:
    "Hello! I'm your SAFEBIZ.AI assistant. I can help you with business setup, supplier guidance, location insights, document requirements, and more. What would you like to know?",
  ...
  useEffect(() => {
    ...
    },
    {
      ...
      category: 'Orders',
      messages: [
      'New order received from Metro Fresh Foods',
      'Order #12346 ready for pickup',
  ...
  const currentNotifications = showPreviousNotifications ?
  notifications :
    ...
    <div className="min-h-screen bg-m2m-bg-primary">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5 relative">
            ...
            <motion.img
              ...
              src="/NearBuy_Logo.png"
              alt="NEARBUY Logo"
              className="w-10 h-10 rounded-xl shadow-lg mx-auto object-contain" />
            ...
            <motion.button
              ...
              className={`absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 bg-m2m-accent-blue rounded-full flex items-center justify-center shadow-lg hover:bg-m2m-accent-teal transition-colors ${sidebarCollapsed ? '' : ''}`}>
              ...
              if (item.isAction) {
                return (
                  <motion.button
                    ...
                    onClick={item.action}
                    className={`w-full flex items-center ${sidebarCollapsed ? 'justify-center px-3' : 'justify-start space-x-3 px-4'} py-3.5 rounded-xl transition-all text-m2m-text-secondary hover:bg-gradient-to-r hover:from-m2m-accent-blue/10 hover:to-m2m-accent-teal/10 hover:text-m2m-text-primary group relative`}
          ...
          <div className="p-4 border-t border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
            ...
            <motion.div
              ...
              <img
                ...
                alt={user?.name || 'User'}
                className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg flex-shrink-0" /> :
            ...
            <motion.div
              ...
              <img
                src={userProfilePhoto}
                alt={user?.name || 'User'}
                className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg" /> :


              <div className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center shadow-lg">
                    <UserIcon className="w-6 h-6 text-white" />
                  </div>
              }
              </motion.div>
        ...
        <>
            ...
            className="fixed left-0 top-0 bottom-0 w-72 bg-m2m-bg-card shadow-2xl z-50 flex flex-col lg:hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-m2m-divider">
                ...
                <button
                onClick={() => setSidebarOpen(false)}
                className="lg:hidden p-2 hover:bg-m2m-bg-primary rounded-lg">
              ...
              <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                if (item.isAction) {
                  return (
                    <motion.button
                      ...
                      onClick={item.action}
                      className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-m2m-text-secondary hover:bg-m2m-bg-primary hover:text-m2m-text-primary">
                ...
                return (
                  <Link
                    ...
                    to={item.path!}
                    onClick={() => setSidebarOpen(false)}
                    className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all ${isActive ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white shadow-md' : 'text-m2m-text-secondary hover:bg-m2m-bg-primary hover:text-m2m-text-primary'}`}>
              ...
              <div className="p-4 border-t border-m2m-divider">
                ...
                <img
                  src={userProfilePhoto}
                  alt={user?.name || 'User'}
                  className="w-10 h-10 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg flex-shrink-0" /> :
              ...
              <div className="relative">
                <motion.button
                  ...
                  <div className="relative">
                    ...
                    <div className="w-10 h-10 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center border-2 border-m2m-divider group-hover:border-m2m-accent-blue transition-colors shadow-md">
                        <UserIcon className="w-5 h-5 text-white" />
                      </div>
                    }
                    {user?.role === 'business' &&
                  ...
                  <>
                      ...
                      className="absolute right-0 mt-2 w-64 bg-m2m-bg-card border border-m2m-divider rounded-2xl shadow-2xl z-50 py-2 overflow-hidden">
                        ...
                        <div className="px-4 py-3 border-b border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
                          ...
                          <div className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center border-2 border-m2m-accent-blue shadow-lg">
                                <UserIcon className="w-6 h-6 text-white" />
                              </div>
                          }
                            <div className="flex-1 min-w-0">
                        ...
                        <div className="py-2">
                          ...
                          return (
                            <motion.button
                              ...
                              onClick={item.action}
                              className={`w-full flex items-center space-x-3 px-4 py-2.5 transition-colors ${item.danger ? 'text-m2m-accent-orange hover:bg-m2m-accent-orange/10' : 'text-m2m-text-secondary hover:bg-m2m-bg-primary hover:text-m2m-text-primary'}`}>
      ...
      <AnimatePresence>
        ...
        <>
            ...
            onClick={() => setSafeBizPanelOpen(false)} />
                ...
                <div className="flex-1 flex flex-col bg-m2m-bg-primary">
                  ...
                  <motion.div
                    ...
                    className={`flex ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                        ...
                        <div
                      className={`max-w-[85%] rounded-2xl px-5 py-3 ${message.type === 'user' ? 'bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white' : 'bg-m2m-bg-card border border-m2m-divider text-m2m-text-primary'}`}>

                          <p className="text-sm whitespace-pre-line">
                            {message.content}
                          </p>
                          <p
                        className={`text-xs mt-2 ${message.type === 'user' ? 'text-white/70' : 'text-m2m-text-secondary'}`}>
                  ...
                  <div className="p-6 bg-m2m-bg-card border-t border-m2m-divider">
                    <div className="flex space-x-3">
                      ...
                      type="text"
                      value={safeBizInput}
                      onChange={(e) => setSafeBizInput(e.target.value)}
                      onKeyPress={(e) =>
                      e.key === 'Enter' && handleSafeBizSend()
                      }
                      placeholder="Type your question here..."
                      className="flex-1 px-5 py-4 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary placeholder-m2m-text-secondary focus:outline-none focus:border-m2m-accent-blue transition-colors" />
                      ...
                      onClick={handleSafeBizSend}
                      className="px-6 py-4 bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white rounded-xl font-medium hover:shadow-lg transition-all">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          className="bg-m2m-bg-card rounded-2xl shadow-2xl max-w-md w-full p-6 border border-m2m-divider">
            ...
            <div className="flex gap-3">
              ...
              className="flex-1 px-4 py-3 border border-m2m-divider text-m2m-text-primary rounded-lg font-medium hover:bg-m2m-bg-primary transition-colors">

                No, Cancel
              </button>
              <button
              onClick={confirmLogout}
              className="flex-1 px-4 py-3 bg-gradient-to-r from-m2m-accent-orange to-red-600 text-white rounded-lg font-medium hover:shadow-lg transition-all">
